...
public final class ServiceDiscoveryFactory {
    ...
    private void discoverIstioGatewayUrl() {
        ...
        try {
            ...
            LOGGER.warn("Failed to reach Kubernetes cluster: '{}'. Enable debug logging to view the full stack trace.", ex.getMessage());
            LOGGER.debug("Error while trying to get access to Kubernetes cluster", ex);
        }
    }
}
